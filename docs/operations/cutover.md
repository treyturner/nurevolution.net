...
- Confirm public feed and both legacy aliases work with non-browser user agents. The observed Cloudflare 1010 denial requires an owner-managed, feed-specific Browser Integrity Check exception; the account DNS token cannot edit this setting. Preserve Full (strict).
