...
Ruminate (`wp-484`) has [20 authored sample boundaries](content/ruminate-track-timings.json), supplied by the owner on 2026-09-17 at 44,100 Hz, replacing the earlier whole-second estimates accumulated from split durations. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `147876609`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `159202834` (approximately 3610.041587 seconds). The existing 3610-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Impulse (`wp-459`) has [16 authored sample boundaries](content/impulse-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, replacing the earlier whole-second timestamps. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `130631692`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `144353067` (approximately 3273.312176 seconds). The existing 3273-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Bass Face Space Race (`wp-454`) has [22 authored sample boundaries](content/bass-face-space-race-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, replacing the earlier millisecond timestamps. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `187773655`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `198788442` (approximately 4507.674421 seconds). The existing 4508-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Lost In Translation (`wp-444`) has [22 authored sample boundaries](content/lost-in-translation-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, replacing the earlier millisecond timestamps. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `123032061`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `133833947` (approximately 3034.783378 seconds). The existing 3035-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Off The Cuff (`wp-435`) has [18 authored sample boundaries](content/off-the-cuff-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, replacing the earlier millisecond timestamps. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `109837860`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `119736708` (approximately 2715.118095 seconds). The existing 2715-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Is This Thing On? (`wp-431`) has [19 authored sample boundaries](content/is-this-thing-on-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, replacing the earlier millisecond timestamps. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `123790007`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `130696144` (approximately 2963.631383 seconds). The existing 2964-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Carrier Detect (`wp-421`) has [30 authored sample boundaries](content/carrier-detect-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, replacing the earlier millisecond timestamps. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `188710590`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `195257748` (approximately 4427.613333 seconds). The existing 4428-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Radio Silenced (`wp-197`) has [50 authored sample boundaries](content/radio-silenced-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, replacing the earlier millisecond timestamps. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `307247714`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `311065685` (approximately 7053.643650 seconds). The existing 7054-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Dancefloor Oriented (`wp-278`) has [13 authored sample boundaries](content/dancefloor-oriented-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, replacing the earlier millisecond timestamps. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `147484167`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `163791308` (approximately 3714.088616 seconds). The existing 3714-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.
...
The Further Esoteric Adventures Of (`wp-269`) has [19 authored sample boundaries](content/the-further-esoteric-adventures-of-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, completing its previously untimed tracklist. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `143130692`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `153889656` (approximately 3489.561360 seconds). The existing 3490-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.

Plush Session (`wp-306`) has [28 authored sample boundaries](content/plush-session-track-timings.json), supplied by the owner on 2026-09-15 at 44,100 Hz, completing its previously untimed tracklist. Each start sample is divided directly by 44,100 in canonical tracklist order, from sample `0` through `198839421`, without millisecond rounding. The evidence preserves all contiguous start/end ranges, ending at sample `210459185` (approximately 4772.317120 seconds). The existing 4772-second episode duration, audio asset, frozen migration evidence, and initial-import provenance remain unchanged.
...
Generation stages complete images beside the manifest, publishes them without replacing existing files, validates the batch, then atomically replaces the manifest. A failed run rolls back its new images; rerunning after a process interruption recovers the pending batch automatically. Run one generator at a time, with the manifest and artwork output on the same filesystem. Interrupted preparation or cleanup can leave private `.preparing-*` or `.pending.cleanup-*` directories beside the manifest; these are ignored by generation and Git and may be removed when no generator is running. Keep a `.pending` directory intact for automatic recovery.
...
`/chapters/<slug>.json` projects known starts from published tracks into Podcasting 2.0 JSON chapters, with titles `NN. Artist - Title`. Fractional seconds retain their canonical precision. Null starts stay absent; incomplete tracklists are not filled in. The same publication predicate protects this endpoint and the feed. The resource-support commit leaves RSS unchanged. The subsequent local advertisement slice adds per-episode JPEG artwork and chapter references whose version hints hash the exact JSON bytes, so timing/title corrections invalidate RSS as well as chapters. Deploy resource support and retain it as the compatible fallback before advertising these URLs, once deployment is authorized. See [feed validation](FEED-VALIDATION.md#m8-resource-support-and-rollout).
