...
1. **M8: listening and feed enhancements.** The owner moved these ahead of publishing: Safari 14.3 compatibility, timestamp sharing, supported lock-screen/headset controls, episode RSS artwork, and feed chapters. All five areas are in scope; implementation has not started. **RSS chapters are not emitted today.** [Agreed scope and acceptance](milestones/M08-listening-and-feed-enhancements.md).
