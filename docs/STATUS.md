...
1. **M8: listening and feed enhancements.** All five areas and the subsequent UI refinements are consolidated into [PR #56](https://github.com/treyturner/nurevolution.net/pull/56) at the owner's request. Historical local gates and their counts are retained in the [M8 evidence record](milestones/evidence/M08-local-verification.json). The owner authorized finalization and merge after fresh CI and automatic review approval. The latest refinements include the episode Play action, a 40/60 list split, condensed track numerals, and preferred artist-name wrapping. The owner confirmed iPad playback, seeking, both reported visual fixes, downloading, and Download MP3 -> View. Dialog/restoration/guest-episode checks, modern-device controls and podcast-client artwork/chapter acceptance remain pending. The owner’s iPadOS 14.3 device supports native system playback/seeking but lacks the Media Session API needed for system artwork and custom skip/track buttons. The workspace preview includes current-origin timestamp links, the playhead context menu, inline track-copy controls, and responsive player refinements. **RSS chapters are not yet deployed.** The resource-support fallback must still be published, deployed, and verified before the RSS-advertisement release; consolidating review does not remove that rollout requirement. The owner authorized the phased deployment on 2026-09-18; preparation and live results are tracked in the [rollout record](operations/m8-rollout.md). [Implementation plan and acceptance](milestones/M08-listening-and-feed-enhancements.md).
