...
| `pnpm build`                                     | Validate content, thumbnails, RSS, and playback indexes, then produce the portable SSR Node application in `.output/`.                                                                        |
...
| `pnpm verify`                                    | Run preparation, formatting, lint, types, migration/operations tests, coverage, content/feed/playback validation, production builds, browser tests, and Docker delivery, stopping on failure. |
