...
| D06 | Design review: mobile information layout                                     | Let the owner try stacked lists and tabs with real content; select based on playback/list navigation usability.                                                                                                                     | M4 layout acceptance                                   |
| D07 | Confirmed automated browser/coverage baseline; accessibility target proposed | Chromium, Firefox, and WebKit from M1; 95% statement/line/function and 90% branch coverage. Proposed later device/accessibility checks: Android Chrome, iPhone Safari, keyboard/screen reader, and applicable WCAG 2.2 AA criteria. | M1 test setup; device/accessibility review in M4       |
