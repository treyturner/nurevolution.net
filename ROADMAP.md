...
| Sequence direction     | Automatic playback moves down the displayed list and wraps. The heading arrow toggles newest-first (down, default) / oldest-first (up). Before any playback, an unplayed top selection follows the new top when flipped. Confirmed. | R2                                     |
...
| D02 | Confirmed: list sort drives all episode navigation                        | Owner revision 2026-09-13: one list-heading sort arrow; Next/automatic go down and Previous goes up. Before playback has ever started, an unplayed top episode follows the new top in either order.                                                                                                          | M7 sequencing plan                                     |
