...
import bassFaceSpaceRaceTimings from '../../docs/content/bass-face-space-race-track-timings.json' with { type: 'json' }
import lostInTranslationTimings from '../../docs/content/lost-in-translation-track-timings.json' with { type: 'json' }
import offTheCuffTimings from '../../docs/content/off-the-cuff-track-timings.json' with { type: 'json' }
import isThisThingOnTimings from '../../docs/content/is-this-thing-on-track-timings.json' with { type: 'json' }
import carrierDetectTimings from '../../docs/content/carrier-detect-track-timings.json' with { type: 'json' }
...
import plushSessionTimings from '../../docs/content/plush-session-track-timings.json' with { type: 'json' }
...
test('serves the complete canonical archive with subscriber identities, track timings and safe projections', async ({
  ...
  for (const expected of ordered) {
    ...
    const authoredTimings = [
      ruminateTimings,
      impulseTimings,
      bassFaceSpaceRaceTimings,
      lostInTranslationTimings,
      offTheCuffTimings,
      isThisThingOnTimings,
      carrierDetectTimings,
  ...
  expect({ tracks, starts }).toEqual({ tracks: 832, starts: 626 })
